...
//--------------------------------------------------------------
void cpGraphStyle( TGraph *g, int c=1, double w=0, int m=0, string title="",
		   double asiz=0, string xtitle="", string ytitle="" )
{
...
void cpHistStyle( TH1 *g, int c=1, double w=0, int m=0, string title="",
		  double asiz=0, string xtitle="", string ytitle="" )
{
  g->SetMarkerColor( c );    // colors
  g->SetLineColor( c );
...
void cpFuncStyle( TF1 *g, int c=1, double w=0, int m=0, string title="",
		  double asiz=0, string xtitle="", string ytitle="" )
{
...
//=======================================================================
pair<double,double> cpAxisLimits( double min, double max, int nDec=0 )
{
